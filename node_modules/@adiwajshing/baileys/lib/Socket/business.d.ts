...
export declare const makeBusinessSocket: (config: SocketConfig) => {
    ...
    relayMessage: (jid: string, message: import("../Types").WAProto.IMessage, { messageId, participant, additionalAttributes, useUserDevicesCache, cachedGroupMetadata }: import("../Types").MessageRelayOptions) => Promise<string>;
