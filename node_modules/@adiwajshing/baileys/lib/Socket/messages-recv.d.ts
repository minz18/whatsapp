...
export declare const makeMessagesRecvSocket: (config: SocketConfig) => {
    ...
    relayMessage: (jid: string, message: proto.IMessage, { messageId, participant, additionalAttributes, useUserDevicesCache, cachedGroupMetadata }: MessageRelayOptions) => Promise<string>;
